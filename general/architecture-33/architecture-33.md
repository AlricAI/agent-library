---
name: ARCHITECTURE
description: Dispatch is a two-component system: a Rust TUI (Console) that manages AI coding agents, and an Android app (Radio) that provides voice input over the local network.
