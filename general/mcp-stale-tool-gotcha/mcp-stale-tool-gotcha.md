---
name: Mcp Stale Tool Gotcha
description: MCP servers that maintain a config-driven allowlist of "optional tools" silently break when the upstream package renames or removes a tool.
