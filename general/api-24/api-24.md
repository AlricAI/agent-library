...
curl -X POST http://localhost:8090/v1/audio/speech \
  ...
  -d '{"input": "Bonjour!", "voice": "eric", "language": "fr"}' \
  -o output.wav
```

### POST `/v1/audio/transcriptions`

OpenAI-compatible transcription with word-level timestamps.
...
```json
{
  ...
  "words": [
    ...
    {"word": "tout", "start": 0.50, "end": 0.72},
    {"word": "le", "start": 0.72, "end": 0.80},
    {"word": "monde", "start": 0.80, "end": 1.20}
  ]
}
```