---
name: Project
description: The goal is to let a single instance of Aictrl run sessions for multiple projects and different worktrees per project.
model: claude-sonnet-4-5
---
## project

The goal is to let a single instance of Aictrl run sessions for multiple projects and different worktrees per project.
