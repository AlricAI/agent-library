---
name: Openai Tools
description: Los modelos más recientes de OpenAI se han ajustado con precisión para detectar cuándo se debe(n) llamar una o más funciones y responder con los datos que se deben pasar a la(s) función(es).
