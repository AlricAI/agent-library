...
Un serveur `ezs` se lance sur un répertoire donné, chaque fichier .ini de ce répertoire deviendra un point d'entrée pour le traitement d
...
Ce paramètre est par défaut égal au nombre de CPUs disponibles sur la machine. Il se
