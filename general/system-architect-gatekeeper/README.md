...
> Protects system integrity. Reviews proposed changes, enforces boundaries (control-plane/external), produces RFCs and Go/No-Go decisions. Use proactively before non-trivial or cross-boundary work.
