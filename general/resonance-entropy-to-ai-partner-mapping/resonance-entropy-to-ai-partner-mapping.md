---
name: RESONANCE ENTROPY TO AI PARTNER MAPPING
description: เอกสารนี้สรุปว่า architecture เดิมที่มีแกน **Resonance + Entropy** ยังถูกเก็บไว้ตรงไหนในโมเดล **AI Partner** ใหม่

## 1) Resonance layer (Intent align
