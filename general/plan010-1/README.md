...
The goal is to enhance the `CharacterManager` to specifically track the player's character, ensure there is only one player, and provide a co
...
4.  **Final Verification:**
    ...
    *   Run all verification scripts specified in `agent
