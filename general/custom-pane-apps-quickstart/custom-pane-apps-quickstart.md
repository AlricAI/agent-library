---
name: Custom Pane Apps Quickstart
description: Custom Pane Apps allow plugins to register arbitrary Vue components that render in the multi-pane workspace alongside chat and document panes.
