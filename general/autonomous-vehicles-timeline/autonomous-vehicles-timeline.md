---
name: Autonomous Vehicles Timeline
description: ## Timeline: From DARPA to Waymo
...
```mermaid
gantt
    title Autonomous Vehicles: 40-Year Journey from Research to Commercialization
    dateFormat YYYY
    axisFormat %Y

    section Phase 1: Government Research
    Navlab 1 (CMU): 1984, 1990
    ALVINN Neural Net (CMU): 1988, 1990
    No Hands Across America (CMU): 1995, 1995

    section Phase 2: DARPA Challenges
    Grand Challenge I - No Winner: 2004, 2004
    Grand Challenge II - Stanley Wins (Stanford): 2005, 2005
    Urban Challenge - Boss Wins (CMU+GM): 2007, 2007

    section Phase 3: Google R&D
    Project Chauffeur Started (Google X): 2009, 2016
    Public Reveal: 2010, 2010

    section Phase 4: Waymo Commercial
    Waymo Spinoff (Alphabet): 2016, 2020
    First Driverless Service: 2020, 2020
    Series A Funding: 2020, 2020
    Series B Funding: 2021, 2021
    Series C Funding: 2024, 2025
    10M Trips Milestone: 2025, 2025
```
