---
name: Agents
description: [AGENTS.md](https://agents.
...
This repository has its own root `AGENTS.md` for working on the template itself.
Generated projects also include an `AGENTS.md` so agents have everything they need from day one.
The file below is the template used for those generated projects, with project-specific values filled in by Copier.
