...
- De nombreuses fonctionnalités liées à l'utilisation d'AgentExecutor, notamment : [l'utiliser comme itérateur](/docs/modules/agents/how_to/agent_iter), [gérer les erreurs d'analyse](/docs/modules/agents/how_to/handle_parsing_errors), [renvoyer les ét
