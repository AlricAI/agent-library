---
name: Element Specs
description: When designing these for baked animation, your aim is not measurement precision but **readability, expressiveness, coherence, and control over “emotion”**.
