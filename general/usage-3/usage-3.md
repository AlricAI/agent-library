---
name: Usage
description: ## Generate a Video from a Topic
...
Each scene can use a different Ken Burns effect:

| Style | Effect |
|-------|--------|
| `ken_burns_zoom_in` | Slow zoom into center |
| `ken_burns_zoom_out` | Slow zoom out from center |
| `ken_burns_pan_left` | Pan from right to left |
| `ken_burns_pan_right` | Pan from left to right |