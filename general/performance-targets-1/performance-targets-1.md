...
description: High-level performance targets for Epona.
...
- Use :telemetry for measurements; export via handlers (no vendor tie-in)
- Keep calculators and predicates pure; avoid tracing in perf runs
- Revisit targets after first implementation; update table with real numbers