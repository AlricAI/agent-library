...
> The application uses a semantic icon system to decouple UI components from specific icon sets (like Pixelarticons or Lucide).
...
2.  Define an object matching `Partial<Record<IconToken
