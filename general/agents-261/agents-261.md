---
name: AGENTS
description: Repository-wide instructions for all agents working in this repo.
...
**Ask {{COORDINATOR_NAME}} first:** Changing scope or ACs in `task.md`. Expanding beyond the original spec. Disagreeing for 2+ consecutive rounds on the same point.
...
## Escalate to {{COORDINATOR_NAME}} When
