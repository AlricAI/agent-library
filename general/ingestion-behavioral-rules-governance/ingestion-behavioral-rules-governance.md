---
name: Ingestion Behavioral Rules Governance
description: ## Pine Script Documentation Pipeline

---

## Purpose
This document defines **behavioral and governance-level rules** that constrain how agents and c
