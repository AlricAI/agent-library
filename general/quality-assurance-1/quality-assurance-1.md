...
Responsibility: Ensure individual documentation instances align with the businesses defined pattern, that all required documentation is present,
model: claude-sonnet-4-5
---
TODO

Responsibility: Ensure individual documentation instances align with the businesses defined pattern, that all required documentation is present, that all inline doctests pass, and that all documentations remains fresh and accurate.
