---
name: Paperclip Connector Recovery Runbook
description: Use this runbook when Blueprint Paperclip automation degrades because GitHub webhook/plugin configuration or Google Calendar server-side configuration is incomplete.
