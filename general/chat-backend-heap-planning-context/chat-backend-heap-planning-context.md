---
name: Chat Backend Heap Planning Context
description: This document describes how the chat backend works when **heap mode** is enabled: the planner, the specialist heap, context passed to the planner and 
