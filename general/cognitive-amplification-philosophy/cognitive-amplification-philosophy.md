---
name: COGNITIVE AMPLIFICATION PHILOSOPHY
description: > **Status (July 2025): The cognitive amplification foundation is now fully implemented, user-accessible, and integrated into the Atlas dashboard and API.
