...
> ## What works
- **Inbound images (user → agent):** Claudio uploads image to `POST {serverURL}/media/upload`, gets back a URL/path, includes it in the 
...
The agent may also output bare i
