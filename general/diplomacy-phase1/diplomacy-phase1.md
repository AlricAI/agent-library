---
name: DIPLOMACY PHASE1
description: This document describes the Phase 1 diplomacy improvements implemented in the game, including Trust, Favors, and Diplomatic Promises systems.
