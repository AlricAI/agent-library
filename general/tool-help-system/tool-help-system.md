---
name: TOOL HELP SYSTEM
description: The `how_to_use` tool provides on-demand documentation for remembrances-mcp tools, significantly reducing initial context token consumption while maintaining full functionality.
