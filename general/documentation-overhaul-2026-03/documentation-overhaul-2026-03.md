---
name: DOCUMENTATION OVERHAUL 2026 03
description: **Later consolidation (scan):** Remaining drifting docs moved into `docs/`: `frontend/admin/docs/navigation-patterns-catalog.
