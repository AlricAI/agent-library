---
name: Additional Logger Improvements To Take Advantage Of It Well
description: This document outlines a strategy for taking full advantage of the new logging infrastructure in the cycod, cycodmd, and cycodt projects.
