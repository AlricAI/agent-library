---
name: ENGINE COMMUNICATION
description: This document explains how Tandem clients communicate with `tandem-engine`, how runs stream, and how desktop/TUI coordinate engine lifecycle.
