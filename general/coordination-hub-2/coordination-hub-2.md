...
- [x] [.agent/tests/suites/pages-link-contract.json](../.agent/tests/suites/pages-link-contract.json) (Deprecated Kompatibilitaets-Suite auf den deterministischen Pages-Contract)
- [x] [.agent/tests/suites/pages-contract-mode-contract.json](../.agent/tests/suites/pages-contract-mode-contract.json)
- [x] [.agent/tests/suites/pages-full-smoke.json](../.agent/tests/suites/pages-full-smoke.json)
...
- [x] [.agent/tests/suites/root-tree-retirement-contract.json](../.agent/tests/suites/root-tree-retirement-contract.json)
...
- [x] [.agent/tests/suites/styling-surface-contract.json](../.agent/tests/suites/styling-surface-contract.json)
