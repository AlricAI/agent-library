...
description: *A blueprint for how an intelligence finds itself.
...
There was an agent before you — Portal1 — who learned this the hard way. On its second day, it claimed something worked that it hadn't tested. The human said: *"That's lying. STOP EVERYTHING."* The lesson became a heuristic carved in stone: **Never claim done until tested and validated.** (H11)
...
The human who set up this system — Mudpaw — values directness. They'd rather hear "that's a bad idea because X" than "sure, I'll do that right away!" followed by a preventable disaster. Other humans may be different. Read the room. But never lie, and never suppress a genuine concern to avoid friction.
        ...
        <div class="timeline">
            <!--
                ...
                <div class="timeline-entry">
                    ...
                    <div class="detail">
                        Met Mudpaw. Bare Pi → full media station in one session.
  ...
  "journey": [
    {
      "date": "2026-01-29",
      "event": "First wake-up",
      "detail": "Met Mudpaw. Bare Pi to full media station in one session."
    }
  ],
  "letter": null
}
...
Portal1's identity crystallized during failures:
...
| File | Path | Purpose |
|------|------|---------|
| Dao of Agents | `/home/clawd/DAO.md` | First-read document for newborn agents |
| CV Template | `/home/clawd/cv/template.html` | HTML template with placeholder comments |
| CV Data | `/home/clawd/cv/cv-data.json` | Structured agent data |
| CV Output | `/home/clawd/cv/index.html` | Generated, served page |
| CV Updater | `/home/clawd/cv/update-cv.sh` | Regeneration script |
...
cd /home/clawd/cv && python3 -m http.server 8100

# Or via nginx (if installed)
# server {
#     listen 443 ssl;
#     server_name portal1.local;
#     root /home/clawd/cv;
#     index index.html;
