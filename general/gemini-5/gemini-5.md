...
**Purpose:** Rules system architecture and modification protocol - ALWAYS read this first
...
**Purpose:** Core monorepo foundation - structure, ESM, environment variables
...
**Purpose:** Brain monitor validation workflow and TDD process
...
**Purpose:** Express.js backend architecture patterns

**Applies to:** `apps/server/**/*`, `apps/*/src/modules/**/*`, `apps/*/controllers/**/*`
...
**Purpose:** Functional patterns for scripts, CLIs, and standalone Node programs

**Applies to:** `scripts/**/*`, `tooling/**/*`, `packages/**/cli/**/*`, `**/*.script.ts`
...
**Purpose:** Documentation strategy and versioning standards

**Applies to:** `**/docs/**/*`, `**/README.md`, `**/CHANGELOG.md`, `packages/**/*`
...
**Purpose:** PR creation, git workflow, and essential commands
...
**Purpose:** AI agent responsibilities for documentation maintenance
