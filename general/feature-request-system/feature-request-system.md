...
description: This document explains how feature requests are produced today, why `waveform`/`pitchWaveform` sometimes fail to appear, and a concrete plan for making the pipeline deterministic.
