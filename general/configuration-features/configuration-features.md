...
description: This document explains the differences and relationships between various configuration features in CycoD: aliases, custom prompts, config files, and profiles.
