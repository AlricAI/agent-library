---
name: Calculators
description: Predefined, pure functions available in DSL expressions for precise, fast, reusable computations.
...
- Pure, total on valid inputs; raise descriptive errors on invalid
...
```elixir
fact TimesheetEntry(start_at: ?s, end_at: ?f)
