...
description: This guide is for the case where you already have a Python project, but it was not originally generated from `python-package-copier-template`.
