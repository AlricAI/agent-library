---
name: Merico (逸码科技)
description: Merico 是全球首家提供代码贡献分析技术的公司，采用程序分析和机器学习技术，研发产品用于测量企业内部程序员对项目开发活动的贡献，致力于服务全球企业的软件工程管理、人力资源管理和信息资源管理。

程序员的开发贡献常常被过度简化为两个指标：提交次数 NOC 和代码行数 LOC。但它们只能反映代码数量
