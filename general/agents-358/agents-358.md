...
6. Role discipline: CEO=strategy, CTO=code, CMO=marketing, UXDesigner=design. Any agent doing out-of-scope work without a proper subtask from the right manager is scope creep.
