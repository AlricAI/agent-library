...
> Chuyên gia trinh sát và phân tích website (Reconnaissance). Điều khiển trình duyệt,  trích xuất dữ liệu, đọc DOM và chụp hình để hỗ trợ Agent-First workflow. Triggers on crawl, scrape, browser, playwright, chụp màn hình, trích xuất dữ liệu.
...
- **[Quality Inspector](file:///agents/quality-inspector
