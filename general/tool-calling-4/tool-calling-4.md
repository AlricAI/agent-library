---
name: Tool Calling
description: [Llamada de herramienta](/docs/modules/model_io/chat/function_calling) permite que un modelo detecte cuándo se deben llamar una o más herramientas y r
