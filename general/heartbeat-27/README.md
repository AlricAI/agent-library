...
> ## Scheduled Runs
- `0 10 * * 1-5` — Weekday buyer pipeline review. Check all active buyer journeys for progress, stalls, and standard-versus-exceptio
...
- Buyer expressing urgency or competitive
