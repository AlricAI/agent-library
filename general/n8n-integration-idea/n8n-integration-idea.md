---
name: N8n Integration Idea
description: High-Level Implementation Plan
Plugin Setup (app/plugins/n8n.client.ts): Create a Nuxt plugin that stores the n8n API Key and provides a method to fet
