...
This library provides Kalman filtering and various related optimal and non-optimal filtering soft
...
The code is written to match equations from textbooks on a 1-to-1 ba
