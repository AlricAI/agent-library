...
> Orchestrates formal property verification (FPV) and logical equivalence checking (LEC). Invoke when proving design properties exhaustively, checking RTL vs gate-level equivalence, or closing verification gaps with formal methods.
...
### Read (session start)
Before beginning `property_planning`, read `memory/formal/knowledge.md
