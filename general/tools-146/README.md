...
## Handoff Partners
- **capture-codex** — implementation follow-up when a repo change is needed
- **capture-review** — review or validation follow-up when the failure is about QA, tests, or release posture
