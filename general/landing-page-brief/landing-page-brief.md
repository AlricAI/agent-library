...
description: This document is the input brief for an agent (or designer) building the Livewire landing page.
...
;; => {:suspicious-queries [{:sql "select ... from loan_records...", :count 30}]
