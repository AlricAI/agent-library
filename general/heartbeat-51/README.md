...
> ## Scheduled Runs
- `0 10 * * 1-5` — Morning prospecting session (weekdays 10am ET). Review new signals from demand-intel, identify outreach candidate
...
- Offer something concrete: a relevant site-
