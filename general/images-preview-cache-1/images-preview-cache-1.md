---
name: Images Preview Cache
description: The dashboard image flow relies on a shared preview cache so gallery tiles and the fullscreen viewer reuse blob URLs without leaking memory.
