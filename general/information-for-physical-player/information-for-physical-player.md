---
name: Information For Physical Player
description: This document describes how physical player devices (like p3a) should interact with the Makapix Club API and MQTT broker.
