---
name: Backlog
description: Last updated: 18 April 2026 — HT-082 shipped after live validation, APPROVED review, and local commit.
...
|---|---|---|---|
| LT-001 | Proxmox auto-discovery | Should | Phase 2 only |
| LT-002 | Docker auto-discovery | Should | Phase 2 only |
| LT-003 | Home Assistant integration | Could | Phase 2 only |
| LT-004 | Multi-workspace support | Must | Phase 2 only |
| LT-005 | Traefik reverse proxy + SSL | Should | Phase 2 only |
