...
> _Ever tried to build a large project with AI assistance, only to watch it struggle as your codebase grows?_
...
_Result: Fewer errors, better code, current standards_
...
│   ├── ai-content/        # Core documentation files
...
1. **Customize your AI context**:
   ...
   - Update `docs/ai-content/project-structure.md` with your tech stack
...
@/docs/ai-content/project-structure.md   # Complete technology stack and file tree
@/docs/ai-content/docs-overview.md       # Documentation routing map
```
...
├── docs/
│   ├── ai-content/            # Foundation documentation (Tier 1)
...
```
"Read and understand the project_structure.md template in docs/ai-content/project_structure.md. Your task is to fill out this template with our project's details. For this send out sub agents in parallel across the whole code base. Once the sub agents get back, ultrathink and create the markdown file."
```
