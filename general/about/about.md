---
name: About
description: Eight autonomous compute stations orbit the Sun at half Earth's distance.
model: claude-sonnet-4-5
---
# About Perihelion

Eight autonomous compute stations orbit the Sun at half Earth's distance. Each runs a persistent AI instance called Iris. One day, Earth goes silent.

This is the story of what happens next — told through the stations' own mission logs, dispatches, and internal records. No narrator. No omniscient voice. Just eight machines writing to themselves about a world that stopped answering.
