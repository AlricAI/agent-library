---
name: Performance
description: See also: specs/performance_targets.
model: claude-sonnet-4-5
---
# Performance Targets and Methodology

See also: specs/performance_targets.md for concrete targets and a results table to update post-implementation.
Defines SLAs and how to measure them. Includes single-tenant and multi-tenant scale targets.

## Scale Targets (Concurrent)

- Tenants: 1000 concurrent engine instances (tenant engines) across a cluster.
...
- Include snapshotting and GC in measurements; report impact of telemetry handlers off vs sampled; keep vendor backends out of hot path.
