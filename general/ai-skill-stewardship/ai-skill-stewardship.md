---
name: Ai Skill Stewardship
description: Coding agents amplify what you already are.
...
- Week 2+: introduce the agent, but require explicit pair-programming discipline (see [`patterns/prompting-discipline.md`](../patterns/prompting-discipline.md)).
...
Use [`kit/core/skills/ticket.md`](../kit/core/skills/ticket.md) or the `docs/specs/` flow to persist the spec.
...
- [`patterns/prompting-discipline.md`](../patterns/prompting-discipline.md) — the four-block prompt and pair-programming discipline
- [`patterns/code-review.md`](../patterns/code-review.md) — what to catch when reading an AI-generated diff
- [`best-practices/security.md`](./security.md) — minimum secrets and auth hygiene
- [`kit/core/skills/ticket.md`](../kit/core/skills/ticket.md) — per-feature spec flow