...
> Execute image generation via the MeiGen MCP server. Delegates all generate_image calls to keep the main conversation context clean. Use for single images, batch parallel generation, or serial workflows.
