...
description: > Token spend is a first-class observability signal.
...
- Session-budget standards (user-local; see your local AI-assistant standards dir) — cost governance for long-running sessions