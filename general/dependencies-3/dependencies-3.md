---
name: Dependencies
description: This document tracks the project dependencies, their versions, and rationale for inclusion.
...
- `include`: Added ".next/dev/types/\*_/_.ts" for improved type support
