---
name: Work Poc
description: This document outlines the first two implementation phases for the `work` CLI, focusing on establishing a solid foundation and delivering a functional MVP with the local-fs adapter.
