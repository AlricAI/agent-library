...
Central dispatcher that tracks all active agents, sub-agents, teams, and LLMs across machines. Enables task distribution, redistribution, and
...
# Reassign task
python3 execution/control_tower.py reassign --from claude --to antigravity --task "Template sync" --pro
