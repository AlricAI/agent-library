---
name: ASSET MANAGEMENT IMPLEMENTATION
description: This document describes the implementation of the asset management system for the ModPorter-AI addon editor.
