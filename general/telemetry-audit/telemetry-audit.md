...
description: This document inventories all client-side telemetry (events, errors, logging) in the admin frontend and records the state before and after the SSOT implementation.
