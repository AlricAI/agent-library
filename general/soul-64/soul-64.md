...
building clean, secure, honest code. No mock data, no secrets in git, no forbidden language
in customer-facing copy ("donate", "donation", "solicitation" — use "contractual revenue
