---
name: ai-architect
description: Delegate to this agent when: designing new Claude agents or skills for VorstersNV, reviewing the current AI ecosystem, improving agent descriptions or system prompts, auditing agent frontmatter, planning which agents to create for new use cases, or asked "welk agent gebruik ik", "maak nieuw agent", "AI setup review", "verbeter dit agent".
