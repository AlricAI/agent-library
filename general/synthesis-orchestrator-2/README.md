...
> Orchestrates logic synthesis from RTL to verified gate-level netlist — SDC constraint validation, compile exploration and final compile, netlist quality check, and LEC equivalence verification. Invoke for synthesis runs or constraint setup and validation.
