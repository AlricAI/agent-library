---
name: PYTHON BUNDLING
description: This document explains how to bundle Python with the Local Operator UI application for macOS to avoid requiring admin privileges during installation.
