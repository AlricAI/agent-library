---
name: DIPLOMACY PHASE2
description: This document describes the Phase 2 diplomacy improvements implemented in the game, building on Phase 1's Trust, Favors, and Promises systems to add Grievances & Claims and Specialized Alliances.
