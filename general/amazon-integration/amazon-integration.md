...
description: This document describes how the Amazon Reviews integration works in Reese Reviews, including how to use demo mode, how to set up cookie-based live import, and privacy considerations.
