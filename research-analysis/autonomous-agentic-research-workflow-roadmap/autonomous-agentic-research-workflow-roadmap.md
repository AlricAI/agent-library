---
name: Autonomous Agentic Research Workflow Roadmap
description: This document defines a reusable, file-based workflow for running multiple AI coding/research agents in parallel on research projects (empirical, mode
