---
name: Datasets
description: This guide lists the main public datasets for training, fine-tuning, and evaluating molecular ML models with Molfun, including download instructions and how each one connects to the library.
