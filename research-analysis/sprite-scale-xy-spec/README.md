# Sprite Scale Xy Spec

> ## Current spec

Die Anforderung ist jetzt ausreichend geklärt: `SpriteData` soll durchgängig echte X/Y-Skalierung unterstützen, mit neuem `float2 Bas
...
A: `BaseScale` als einfacher Modus, 
