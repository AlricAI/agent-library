---
name: Generation Analytics Examples
description: This document provides practical examples for querying generation analytics data, including direct SQL queries and API usage examples.
