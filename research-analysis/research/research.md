---
name: Research
description: This page provides a curated collection of influential research papers on Kalman and Bayesian filtering, from foundational works to modern advancements.
