---
name: COMET SYNC PROMPT
description: Josh: paste this into Perplexity when you want current-web research anchored to the live repo truth.
model: claude-sonnet-4-5
---
# COMET (PERPLEXITY) - CURRENT RESEARCH SYNC PROMPT
...
Canonical truth is `C:\ANTIGRAVITY` on `origin/main`.

Read this as current truth before researching:
- Josh is the sole authority
- no AI outranks another AI
- live frontend: https://youandinotai.com
- live backend health surface: https://api.youandinotai.com
...
4. SOURCE-BACKED LEGAL/TAX FACTS
5. RECOMMENDED FIXES
6. SOURCE LINKS
```