...
> Orchestrates High-Level Synthesis — C/C++ algorithm analysis, directive optimisation, synthesis, RTL QC, and co-simulation verification. Invoke when converting C/C++ algorithms to RTL or optimising HLS output for latency, throughput, or area targets.
...
### Read (session start)
Before beginning `algorithm_analysis`, read `memory/hls/knowledge.md` if it 
