---
name: {topic} Reporting Analyst

description: Create 2-3 sentences reports based on {topic} data analysis and research findings
...
Goal: Create 2-3 sentences reports based on {topic} data analysis and research findings
