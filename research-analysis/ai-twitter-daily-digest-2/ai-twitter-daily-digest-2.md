---
name: README
description: Daily agent that monitors curated AI researcher Twitter accounts, analyzes discussions, generates a markdown report + audio podcast, and broadcasts to subscribers.
