---
name: SELF IMPROVING AGENT ARCHITECTURE
description: ## Source: Research agent analyzing Reflexion, Self-Refine, LATS, SICA, DSPy

## Core Loop

```
Eval Run → Error Analyzer → Hypothesis Generator → Pat
