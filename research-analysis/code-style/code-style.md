---
name: Code Style
description: description: Writing readable, maintainable code globs: **/* Code Style
---
---
...
+ Always validate the data coming from the API using `arktype`, DO NOT cast or assume the data is valid