---
name: System Context
description: This document provides a comprehensive overview of the Tandem project for AI agents (like yourself) to understand the architecture, security model, and operational guidelines of the system.
