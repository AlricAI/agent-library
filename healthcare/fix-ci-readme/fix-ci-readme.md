---
name: FIX CI README
description: This directory contains the `fix-failing-ci-checks` command for automatically detecting, diagnosing, and fixing failing CI checks for pull requests.
