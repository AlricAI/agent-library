...
description: This document explains how to diagnose and improve AmneziaWG/WireGuard tunnel stability in "hard" networks (aggressive NAT, high jitter, UDP filtering).
