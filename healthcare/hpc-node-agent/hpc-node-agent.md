---
name: Hpc Node Agent
description: The HPC Node Agent is a lightweight daemon that runs on HPC compute nodes to report health, capacity, and latency metrics to the provider daemon for on-chain node metadata updates.
