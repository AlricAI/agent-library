---
name: Marketplace Semantic Search
description: This repo supports a hybrid semantic search for the Marketplace UI:

- **Production default:** live search over Firestore `marketplace_items`, with ve
