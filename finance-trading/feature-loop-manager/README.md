...
> Autonomous feature loop manager for the marketing dashboard. Takes a basic prompt or TIP, then iteratively runs architect, developer, and tester_reviewer until completion. Use when you want fire-and-forget implementation with no approval checkpoints.
