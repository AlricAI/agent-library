---
name: Phase Reset Architecture
description: ## Background

When autonomous agents process long, multi-step workflows (like "Discovery → Investigation → Design → Build"), their context window acc
