...
> Debugger Agent for interactive troubleshooting, code fixes, and small-scale edits. Use this agent to diagnose, debug, and resolve issues in the codebase. All code and spec changes must be kept in sync, and every bug/fix must be logged to Notion under the Marketing Dashboard > Bugs page.
