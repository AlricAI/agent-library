---
name: Findash Agent Modules (Octopus Trading Platform)
description: description: Findash/Octopus 11-agent architecture; apply when editing agent modules or orchestrator. globs: src/core/intelligence_orchestrator.py, src/data_processing/**/*.py, src/analytics/**/*.py, src/strategies/**/*.py, src/prediction/**/*.py, src/risk/**/*.py, src/backtesting/**/*.py, src/realt
---
---
