...
> The wiki content has been prepared in this folder.
...
```bash
cd /tmp && rm -rf Findash.wiki && git clone https://github.com/massoudsh/Findash.wiki.git && cd Findash.wiki && rm -f *.md && cp /Users/massoudshemirani/MyProjects/Octopus/Findash/wiki-content/*.md . && git add -A && git commit -m "Add comprehensive wiki docum
