...
> Qualitative skill reviewer using Sonnet-level judgment. Evaluates content quality, actionable trigger descriptions, and prompt injection patterns. Merges results into existing Tier 1 NDJSON entries. Only dispatched for non-fork, non-trivial, available skills.
