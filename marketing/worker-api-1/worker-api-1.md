---
name: WORKER API
description: The Atlas Worker API enables distributed processing of transcription and content processing jobs across multiple machines (primarily Mac Mini workers).
