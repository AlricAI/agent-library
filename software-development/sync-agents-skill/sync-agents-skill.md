...
description: Sync Agents Skill This project uses an automated script to synchronize the root `AGENTS.md` and all specific agent skills within the `skills/` directory across all major AI code editing tools. # Supported Tools
---
# Sync Agents Skill
