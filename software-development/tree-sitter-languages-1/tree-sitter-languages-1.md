...
description: This document details the programming languages supported by the Code Indexing System, including which symbol types are extracted and any language-specific considerations.
