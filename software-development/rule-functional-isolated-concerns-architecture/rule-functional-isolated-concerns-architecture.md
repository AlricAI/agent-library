---
name: Rule: Functional Isolated Concerns Architecture
description: description: Functional patterns for scripts, CLIs, and standalone Node programs globs: - "scripts/**/*"
---
---
