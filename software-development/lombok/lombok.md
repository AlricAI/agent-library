---
name: Lombok
description: Project Lombok is a Java library that automatically plugs into your editor and build tools to eliminate boilerplate code through annotations.
