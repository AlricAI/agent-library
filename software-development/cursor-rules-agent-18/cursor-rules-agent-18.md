...
description: # Instruction to developer: save this file as .cursorrules and place it on the root project directory # Core Principles - Follow **SOLID**, **DRY**, **KISS**, and **YAGNI** principles
---
