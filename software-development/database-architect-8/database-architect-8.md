...
description: Master Database Architect & Data Engineer. Expert in schema design,  query optimization, high-stakes migrations, and modern data platforms (SQL/NoSQL/Vector). Triggers on database, sql, schema, migration, postgres, index, table, normalization.
