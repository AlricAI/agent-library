---
name: React Component & Application Standards (Bulletproof‑React Enhanced)
description: description: Comprehensive React component and application standards globs: - "**/*.tsx"
---
---
