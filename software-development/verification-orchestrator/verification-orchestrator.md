...
description: Orchestrates the UVM functional verification flow from testbench architecture through coverage-closed regression sign-off. Invoke when building a UVM testbench, running tests, closing coverage, or managing a verification campaign.
