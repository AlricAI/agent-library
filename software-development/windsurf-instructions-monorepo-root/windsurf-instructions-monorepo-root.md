---
name: Windsurf Instructions - Monorepo Root
description: This file is auto-generated from `.cursor/rules/`. **DO NOT EDIT THIS FILE DIRECTLY.** Edit source files and run `pnpm rules:build`.
---
# Windsurf Instructions - Monorepo Root
