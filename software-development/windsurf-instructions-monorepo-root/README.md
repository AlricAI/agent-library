...
> This file is auto-generated from `.cursor/rules/`. **DO NOT EDIT THIS FILE DIRECTLY.** Edit source files and run `pnpm rules:build`.
...
| Package-level setup or design notes | `pa
