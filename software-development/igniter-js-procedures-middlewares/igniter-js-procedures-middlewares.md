---
name: Igniter.js: Procedures (Middlewares)
description: description: Provides the correct and validated pattern for creating and using procedures (middlewares) in Igniter.js. globs: src/features/**/* alwaysApply: false
---
---
