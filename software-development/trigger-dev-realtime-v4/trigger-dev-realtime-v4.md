---
name: Trigger.dev Realtime (v4)
description: description: How to use realtime in your Trigger.dev tasks and your frontend globs: **/trigger/**/*.ts alwaysApply: false
---
---
