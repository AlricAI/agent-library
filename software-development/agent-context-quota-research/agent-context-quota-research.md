---
name: Agent Context Quota Research
description: This note tracks recurring pain points for Codex/Claude-style agent workflows and maps them to OmniMem implementation choices.
