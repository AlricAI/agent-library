---
name: Trigger.dev Configuration (v4)
description: description: Configure your Trigger.dev project with a trigger.config.ts file globs: **/trigger.config.ts alwaysApply: false
---
---
