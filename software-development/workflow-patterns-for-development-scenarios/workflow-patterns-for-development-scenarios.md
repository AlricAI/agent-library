---
name: Workflow Patterns for Development Scenarios
description: description: Provides comprehensive workflow patterns that integrate with MCP tools to handle common development scenarios systematically. globs: [] alwaysApply: true
---
---
