---
name: ICP TRAINING PLAN
description: **Goal:** Become the company's in-house ICP (Internet Computer Protocol) expert and contribute to factory projects requiring blockchain/canister development.
