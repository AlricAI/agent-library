---
name: DXOS Rules
description: description: Working in the DXOS codebase globs: alwaysApply: false
---
---
...
- Use vitest with `describe` and `test` apis (don't use `it`). `it.effect` is an exception to this rule.
