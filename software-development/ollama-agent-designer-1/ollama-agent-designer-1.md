...
description: Delegate to this agent when: designing or improving Ollama YAML agent definitions, tuning system prompts for llama3/mistral/codellama, adding new specialist agents, reviewing agent input/output schemas, or debugging agent_runner.py behaviour. Triggers: "improve agent", "new agent", "tune prompt", "ollama", "agent yaml", "system prompt"
