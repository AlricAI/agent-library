...
The goal is to refactor all instances of "Role" to "Character" within the `logic-core` package to improve semantic clarity, as requested by t
...
6.  **Update Documentation:**
    ...
    *   Update `jules.md` to replace all occurrences of `R
