...
| Resource | Path |
|----------|------|
| Skill definition | `content/skills/pkgmgr-homebrew-formula-dev/SKILL.md` |
| JSON Schema | `content/skills/pkgmgr-homebrew-formula-dev/scripts/formula.schema.ts` |
| Helper functions | `content/skills/pkgmgr-homebrew-formula-dev/scripts/formula.helper.ts` |
| Main template | `content/skills/pkgmgr-homebrew-formula-dev/reference/templates/main.mustache` |
| Language partials | `content/skills/pkgmgr-homebrew-formula-dev/reference/templates/langs/*.mustache` |
| Test fixtures | `content/skills/pkgmgr-homebrew-formula-dev/test/data/*.json` |
| Go reference | `content/skills/pkgmgr-homebrew-formula-dev/reference/go.md` |
| Rust reference | `content/skills/pkgmgr-homebrew-formula-dev/reference/rust.md` |
| Python reference | `content/skills/pkgmgr-homebrew-formula-dev/reference/python.md` |
