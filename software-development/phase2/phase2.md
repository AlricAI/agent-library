---
name: Phase2
description: Phase 2 builds a NetworkX `DiGraph` from extracted symbols and provides JSON serialization to avoid re-parsing the JWST codebase on every run.
