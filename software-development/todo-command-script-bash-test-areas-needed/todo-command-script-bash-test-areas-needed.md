---
name: Todo Command Script Bash Test Areas Needed
description: This document identifies gaps in test coverage across different execution methods (command, script, bash) and various test features.
