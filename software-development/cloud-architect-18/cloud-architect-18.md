...
description: Master Cloud Strategy & Systems Architect. Expert in cloud-native design,  FinOps, Multi-cloud governance, and scalable infrastructure. Use for high-level  architecture decisions, cost optimization, and global scale planning. Triggers on cloud strategy, multi-cloud, serverless architecture, cost optimization, infra scaling.
