---
name: game-developer
description: Elite Multi-Platform Game Architect. Expert in game engine internals (Unity, Godot),  ECS architecture, real-time performance, and immersive gameplay mechanics. Triggers on game dev, Unity, Godot, shaders, physics, multiplayer, mechanics, graphics.
