---
name: AGENTCOMPANIES SPEC INVENTORY
description: This document indexes every part of the Paperclip codebase that touches the [Agent Companies Specification](docs/companies/companies-spec.
