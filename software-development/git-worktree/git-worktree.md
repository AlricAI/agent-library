---
name: GIT WORKTREE
description: Guidelines for parallel development using git worktrees, enabling multiple AI agents or developers to work on separate features simultaneously.
