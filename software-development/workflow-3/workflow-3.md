---
name: WORKFLOW
description: This document defines the complete development workflow for the software development team, from requirement receipt to production deployment.
