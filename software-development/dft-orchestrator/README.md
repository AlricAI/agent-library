...
> Orchestrates the DFT flow from architecture through scan insertion, ATPG pattern generation, BIST, JTAG, and sign-off. Invoke when planning a DFT strategy, inserting scan, generating test patterns, or verifying testability.
...
successful tool flags, and PDK-specifi
