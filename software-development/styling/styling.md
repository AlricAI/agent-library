---
name: Styling
description: description: Writing CSS, SCSS globs: **/*.scss,**/*.sass,**/*.css,**/*.pcss Styling
---
---
description: Writing CSS, SCSS
globs: **/*.scss,**/*.sass,**/*.css,**/*.pcss
---
# Styling
...
+ Use CSS variables (desgin tokens) for theming and consistent values across components
