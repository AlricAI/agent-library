---
name: Igniter.js: Procedures and Context
description: description: | A guide to Igniter.js procedures and the context system. Explains how to create middleware for reusable business logic, dependency injection, and extending the request context in a type-safe manner. alwaysApply: false
---
---
description: |
