---
name: TDD Workflow
description: description: Test-Driven Development workflow for Project with Brain Garden integration globs: - "**/*.test.ts"
---
---
...
Project uses Brain Garden's `brain-monitor` for continuous validation:
...
**No exceptions.** This is Project's discipline.
...
- `project-motivation-system.rules.mdc` - Motivation metrics being tested

---

**Remember:** Tests prove features work. Without E2E tests proving motivation metrics display correctly, the Project's core mission fails.
