---
name: **Cursor Agent Rule: Modular Core/Adapter Monorepo Architecture**
description: description: Express.js hexagonal architecture with functional DI patterns and modular structure globs: - "apps/\*\*/\*"
---
---
