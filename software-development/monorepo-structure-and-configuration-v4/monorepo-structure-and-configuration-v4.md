---
name: Monorepo Structure and Configuration (v4)
description: description: Core monorepo structure, ESM-only, no-build libraries, shared config, agent coordination globs: - "**/*"
---
---
