---
name: E2E: local providers only
description: description: E2E tests use only local LLM and embedding providers; never cloud globs: "packages/ui/__tests__/e2e/**/*.e2e.ts" alwaysApply: false
---
---
