---
name: Igniter.js Client Usage Guide
description: description: | Comprehensive guide to using the Igniter.js Client, covering server-side and client-side usage patterns, React hooks (useQuery, useMutation, useRealtime), context management, realtime features, and best practices.
---
---
description: |
