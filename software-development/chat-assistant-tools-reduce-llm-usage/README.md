...
> description: Chat tools — prefer server-side / skip-LLM paths for deterministic actions globs: packages/ui/app/api/chat/**/*.ts, packages/runtime/src/chat/tools/**/*.ts alwaysApply: false
