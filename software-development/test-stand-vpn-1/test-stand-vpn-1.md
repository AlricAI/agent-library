---
name: TEST STAND VPN
description: **Purpose:** (1) Get a VPN config file from the server (issue flow), (2) Use that config in a test stand to connect to the internet (WireGuard up → curl → verify).
