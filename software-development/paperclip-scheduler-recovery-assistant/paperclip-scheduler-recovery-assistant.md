---
name: Paperclip Routine Scheduler Recovery Handoff 2026 04 02
description: Use the prompt below as the starting instruction set for the next repair session.
