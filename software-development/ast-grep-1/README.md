...
> description: Using ast-grep for superior code search, syntax-aware and structural matching alwaysApply: true MANDATORY SEARCH TOOL: ALWAYS use `sg` (ast-grep) as FIRST OPTION for ANY code search, syntax-aware or structural matching, or even grepping task. For example: `sg -p <pattern> -l <language>`
