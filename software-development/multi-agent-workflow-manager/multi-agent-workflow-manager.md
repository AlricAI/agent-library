---
name: Multi-agent workflow (skills and subagents)
description: description: Multi-agent workflow — when to use skills and subagents, execution order. See PROMPT.md for the full workflow. globs: [] alwaysApply: true
---
---
description: Multi-agent workflow — when to use skills and subagents, execution order. See PROMPT.md for the full workflow.
globs: []
alwaysApply: true
---
