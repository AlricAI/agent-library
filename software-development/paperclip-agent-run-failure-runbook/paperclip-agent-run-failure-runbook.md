---
name: Paperclip Agent Run Failure Runbook
description: Use this runbook when a Blueprint Paperclip alert says an agent run failed, especially when the failure came from a local Codex or Claude lane while working an active issue.
