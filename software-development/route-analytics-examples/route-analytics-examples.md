---
name: Route Analytics Examples
description: This document provides practical examples for working with the route analytics system, including SQL queries for monitoring, debugging, and analysis.
