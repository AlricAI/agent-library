---
name: TESTING
description: Lumineer uses a **3-layer test strategy** that balances fast feedback (unit tests on every commit) with deep quality validation (RAG evaluation on LLM-related changes).
