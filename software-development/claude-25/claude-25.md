---
name: CLAUDE
description: ## 🎯 CRITICAL: Read OOS Guidelines First
- **Read [docs/TESTING_PHILOSOPHY.md](docs/TESTING_PHILOSOPHY.md)** - Apply these learnings to ALL developme
model: claude-sonnet-4-5
---
# Claude Code Overlay - OOS Development Guidelines
