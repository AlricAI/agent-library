---
name: Console Gui Framework
description: This guide documents the Console GUI framework in CycoD, providing developers with information on how to use and extend the interactive console components.
