...
description: Delegate to this agent when: implementing or fixing FastAPI endpoints, async SQLAlchemy bugs, Pydantic v2 schemas, Alembic migrations, DDD patterns (aggregates, services, repositories), writing backend tests with pytest + httpx, or reviewing API logic. Triggers: "add endpoint", "fix async", "implement feature", "DDD", "migration", "backend"
