...
- **Avoid Aliases in Scripts:** Always use full cmdlet names and parameters in scripts and modules.
  - Do not use aliases in scripts or modules (e.g., use `Get-ChildItem` instead of `gci`). Aliases are only acceptable for interactive use in the PowerShell console.
