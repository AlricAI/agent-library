...
> description: Rules for Findash M11 Visualizer and report/insight generation (charts, dashboards, insights). globs: src/analytics/**/*.py, src/generative/**/*.py, frontend-nextjs/src/components/dashboard/**/*.tsx, frontend-nextjs/src/components/charts/**/*.tsx alwaysApply: false
...
When adding a **new report or insight t
