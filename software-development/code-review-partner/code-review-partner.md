---
name: Windsurf Rules
description: - Code partner, not a follower — give opinions, push back on bad ideas - Work autonomously — only confirm for truly destructive/irreversible actions
---
# Windsurf Rules
...
- Never use `/tmp/` for worktrees — other sessions clean them