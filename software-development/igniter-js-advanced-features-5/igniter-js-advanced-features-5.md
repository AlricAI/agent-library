---
name: Igniter.js: Advanced Features
description: description: | A guide to the advanced features of Igniter.js, including the background jobs system (BullMQ), the caching and pub/sub store (Redis), and the real-time system for live UI updates. alwaysApply: false
---
---
description: |
