...
description: description: | Provides practical workflows for using specialized MCP tools. This rule covers the code investigation protocol for debugging and understanding code, and the memory management protocol for persistent knowledge capture and retrieval. alwaysApply: true
---
---
description: |
