---
name: DraftThingsWeKnowWeWant
description: Goal: a system for agentic autonomous coding that has a built-in self-improvement loop

- Building on claude code and its sub agents, commands, tools,
