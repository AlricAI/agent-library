---
name: Moltler - elastic-script Development Rules
description: Moltler - elastic-script Development Rules # Project Overview This is the Moltler project - a procedural scripting language (elastic-script) that runs inside Elasticsearch for runbook automation, AI/LLM integration, and data processing.
---
...
- `cluster-management`: Cluster health and nodes
- `observability`: Logs, metrics, traces
- `security-ops`: Users, roles, API keys
- `ml-inference`: ML and AI/LLM capabilities
- `data-management`: ILM, snapshots, pipelines
- `alerting-response`: Alerts and notifications
- `integrations`: AWS, K8s, CI/CD
