---
name: Igniter.js: Controllers and Actions
description: description: | A focused guide on creating Igniter.js controllers and actions (queries and mutations). This rule details the properties, validation layers (Zod and Ensure), and the response object for building API endpoints. alwaysApply: false
---
---
description: |
