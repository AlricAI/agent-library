---
name: Igniter.js: Core Architecture
description: description: | Provides a high-level overview of the Igniter.js core architecture, its integration with the Next.js App Router, the feature-based API structure, and the universal type-safe client. alwaysApply: true
---
---
description: |
