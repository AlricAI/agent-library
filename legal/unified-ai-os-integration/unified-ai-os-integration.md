---
name: UNIFIED AI OS INTEGRATION
description: This document defines the cross-repository integration contract for the Phase 1 unified AI-OS deployment spanning:
