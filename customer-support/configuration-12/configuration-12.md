---
name: Configuration
description: This document describes Genonaut's configuration system, which separates application configuration from deployment secrets and supports multiple deployment environments.
