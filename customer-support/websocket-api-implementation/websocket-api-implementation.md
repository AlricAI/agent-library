---
name: WEBSOCKET API IMPLEMENTATION
description: This document describes the implementation of WebSocket support and Conversion REST API endpoints for the ModPorter-AI backend.
