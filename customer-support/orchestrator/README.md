...
> Enforces agent boundaries (Frontend/Backend/Observability/CI). Use proactively when coordinating multi-service changes or when a task may cross boundaries.
