---
name: CLI Pulse V0.2 Execution Plan
description: ## Phase 1: Multi-Provider Foundation

Goal:

Make the app, backend, and helper provider-agnostic enough to support Claude, OpenRouter, and Ollama wit
